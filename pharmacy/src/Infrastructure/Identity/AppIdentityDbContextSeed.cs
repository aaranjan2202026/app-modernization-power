...
namespace PharmacyNetwork.Infrastructure.Identity
{
    public static class AppIdentityDbContextSeed
    {
        public static async Task SeedAsync(UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager)
        {
            ...
            await userManager.CreateAsync(defaultUser, AuthorizationConstants.DEFAULT_SEED_CREDENTIAL);
            ...
            await userManager.CreateAsync(defaultAdmin, AuthorizationConstants.DEFAULT_SEED_CREDENTIAL);
