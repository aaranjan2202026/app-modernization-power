...
- SonarQube access for quality validation (MANDATORY — Phase 7 prompts for URL + token)
...
- Audit report generated at `Migration/FINAL-AUDIT-REPORT.md`
...
| SonarQube unreachable | Retry 3 times, then STOP (Phase 7 is MANDATORY) |
| User does not provide credentials | STOP — scan is mandatory |
